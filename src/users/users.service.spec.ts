...
describe('UsersService', () => {
  ...
  beforeEach(async () => {
    ...
    rabbitService = module.get<MicroserviceService>(MicroserviceService);
  ...
  describe('creates a user', () => {
    ...
    it('should create a user successfully', async () => {
      ...
      expect(rabbitService.send).toHaveBeenCalledWith(
        createUserDto.name,
        createUserDto,
      );
      expect(result).toEqual(
...
describe('remove', () => {
  ...
  it('should return 400 if an exception occurs', async () => {
    const userId = '3';
    jest
      .spyOn(imageRepo, 'findOneBy')
      .mockRejectedValue(
        ErrorResponse(404, 'unable to retrieve user', null, null),
      );
